...
public class burgers_menu extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.button:
                Intent otherActivity = new Intent(getApplicationContext(), please_wait.class);
                startActivity(otherActivity);
                break;
            case R.id.button2:
                Intent otherActivity1 = new Intent(getApplicationContext(), please_wait.class);
                startActivity(otherActivity1);
                break;
            case R.id.button3:
                Intent otherActivity2 = new Intent(getApplicationContext(), please_wait.class);
                startActivity(otherActivity2);
                break;
            case R.id.button4:
                Intent otherActivity3 = new Intent(getApplicationContext(), please_wait.class);
                startActivity(otherActivity3);
                break;
            case R.id.button5:
                Intent otherActivity4 = new Intent(getApplicationContext(), please_wait.class);
